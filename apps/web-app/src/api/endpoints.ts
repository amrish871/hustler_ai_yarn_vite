...
export const API_MY_USER_ADDRESSES  = "/api/v1/user-addresses/my_address/"
...
export const API_SET_DEFAULT_USER_ADDRESS = (userAddressId: number | string) => `/api/v1/user-addresses/${userAddressId}/set-default/`
...
// place order
export const API_PLACE_ORDER = `/api/v1/orders/comprehensive/`
